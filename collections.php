...
<div class="smooth-scroll">
  <div class="section-wrapper" data-scroll-section>
    ...
    <aside class="side-widget">
      ...
      <figure class="logo"> <img src="src/images/logo-light.png" alt="Image"> </figure>
      <!-- end logo -->
      <div class="inner">
        <div class="widget">
          <figure><img src="src/images/image07.jpg" alt="Image"></figure>
    ...
    <nav class="navbar">
      <div class="logo"> <a href="index.html"> <img src="src/images/logo.png" alt="Image"> </a> </div>
      <!-- end logo -->
      <div class="custom-menu">
        <ul>
          <li><a href="#">Eng</a></li>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-6">
            <div class="collection-box" data-scroll data-scroll-speed="1.5" >
              <figure><img src="src/images/collection01.jpg" alt="Image"></figure>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="collection-box" data-scroll data-scroll-speed="1" >
              <figure><img src="src/images/collection02.jpg" alt="Image"></figure>
...
The mummy of the priest Hornedjitef was encased in a gilded mask and cover, and two human-shaped wooden coffins. </p>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="collection-box" data-scroll data-scroll-speed="0.5" >
              <figure><img src="src/images/collection03.jpg" alt="Image"></figure>
...
This crowned head was discovered by accident in 1939 during digging close to the royal palace in Ife. </p>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="collection-box" data-scroll data-scroll-speed="1.5" >
              <figure><img src="src/images/collection04.jpg" alt="Image"></figure>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="collection-box" data-scroll data-scroll-speed="1" >
              <figure><img src="src/images/collection05.jpg" alt="Image"></figure>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="collection-box" data-scroll data-scroll-speed="0.5" >
              <figure><img src="src/images/collection06.jpg" alt="Image"></figure>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="collection-box" data-scroll data-scroll-speed="1.5" >
              <figure><img src="src/images/collection07.jpg" alt="Image"></figure>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="collection-box" data-scroll data-scroll-speed="1" >
              <figure><img src="src/images/collection08.jpg" alt="Image"></figure>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="collection-box" data-scroll data-scroll-speed="0.5" >
              <figure><img src="src/images/collection09.jpg" alt="Image"></figure>
    ...
    <section class="content-section">
      <div class="video-bg">
        <video src="src/videos/video.mp4" loop autoplay playsinline muted></video>
      </div>
      <!-- end video-bg -->
      <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <div class="newsletter-box">
              ...
              <!-- end form -->
              <figure class="newsletter-image" data-scroll data-scroll-speed="0.7"><img src="src/images/newsletter-image.png" alt="Image"></figure>
            </div>
            <!-- end newsletter-box --> 
          </div>
          <!-- end col-12 --> 
